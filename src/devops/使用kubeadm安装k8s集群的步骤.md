...
> 如果你使用centos7，yum仓库已经被废弃了，需要手动修改一下yum源,下面代码是改成阿里的yum源仓库地址
>
...
下面附上一个老版本的flannel的yaml,因为如果你安装k8sv1.17.4的话，需要使用老版本的flannel
...
<img src="E:\b站视频批量下载\Shandou\下载保存目录\哔哩哔哩视频\资料-容器集群管理系统k8s从入门到精通\容器集群k8s从入门到精通资料day01\assets\image-20200405142656921.png" alt="image-20200405142656921" style="zoom:80%; border:1px solid" />
